...
parser.add_argument("-name", "--name", help = "name and title")
...
fig, (figure)= plt.subplots(nrows=1, figsize=(14,9))
"""
...
bar.set(ylabel = 'Interface Energy', title = str(args.name))
plt.xticks(rotation=90 )
plt.savefig(str(args.name) + ".png",dpi = 400)
